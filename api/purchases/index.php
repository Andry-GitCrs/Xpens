...
} elseif ($filter_by_date && !$get_total_expense_by_date && !$get_total_expense_by_date_range && !$get_total_expense) { # /api/purchases?purchase_date=dd-mm-yyyy
...
} elseif ($get_total_expense_by_date && !$get_total_expense_by_date_range && !$get_total_expense) { # /api/purchases?purchase_date=dd-mm-yyyy&get_total_expense=1
